...
# Load data
df = pd.read_csv('20250722_pricedata.csv')
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Div([
            html.Div([
                html.H2("Preisentwicklung seit Q2/2024", style={'textAlign': 'center'}),
...
def update_tiles(selected_category, selected_age_cat):
    ...
    q4_2023_data = filtered_data[filtered_data['Quarter'] == '2025Q2']
    median_price_2023 = round(q4_2023_data['Verkaufspreis'].median())

    # Calculate percentage difference vs. Q4 2022
    q4_2022_data = filtered_data[filtered_data['Quarter'] == '2024Q2']
    ...
    current_quarter_period = pd.Period('2025Q2', freq='Q')  # Ändern Sie dies entsprechend, um das aktuelle Quartal dynamisch zu bestimmen
    ...
    tile_1_content = html.Div([
        ...
        html.Div("(Q2/2025):", style={'margin-bottom': '10px'}),
    ...
    html.Div("(vs. Q2/2024):", style={'margin-bottom': '10px'}),
    html.Div([
...
def update_data_alert(selected_category, selected_age_cat):
    ...
    # Filter data for Q4
    q4_data = filtered_data[filtered_data['Quarter'] == '2025Q2']  # Adjust the year as needed
